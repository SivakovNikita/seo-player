const FAQData = [
  ...
  },
  {
    ...
    text: (
      <span>
        Плеербар, это виджет плеера, который идеально подходит для одного трека или демо-записи нескольких композиций в
        одном аудиофайле. В плеербаре есть кнопка с призывом к действию, она появляется когда пользователь начинает
        воспроизведение, индикация воспроизведения и загрузки, название композиции и возможность перематывать трек.
        <br />
